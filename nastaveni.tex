...
Tato semestrální práce se zabývá návrhem modulu pro dvouvodičový \acs{JTAG} protokol a návrhem rozšiřujícího protokolu pro přístup na systémovou sběrnici \acs{RISC-V} procesoru. Navržený modul bude použit pro testování integrovaného obvodu pomocí dvouvodičového rozhraní, za účelem redukce počtu pinů. Rozšiřující protokol bude sloužit pro časovou optimalizaci testování integrovaného obvodu. Práce obsahuje popis systému pro testování \acs{RISC-V} procesorů, navrženého modulu pro dvouvodičový \acs{JTAG} protokol, včetně způsobu jeho implementace, a návrhu optimalizovaného protokolu.
}
