...
Tato kapitola popisuje princip přenosu dat pomocí komunikačního protokolu \acs{JTAG} a jeho použití pro testování obvodů obsahujících procesor s instrukční sadou \acs{RISC-V}. V kapitole je také přiblížen princip fungování systémové sběrnice použitého \acs{RISC-V} procesoru.
